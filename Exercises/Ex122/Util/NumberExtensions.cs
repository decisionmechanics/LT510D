	...
	public static class NumberExtensions
	{
		...
		public static string ToText(this long number)
		{
			...
			if (number < 100)
			{
				...
				if (unit == 0) return decades[dix];
				string text =  decades[dix] + " " + unit.ToText();
				return text;
			}
			if (number < 1000) return Encode(number, 100, "hundred");
			if (number < 1000000) return Encode(number, 1000, "thousand");
			if (number < 1000000000) return Encode(number, 1000000, "million");
			if (number < 1000000000000L) return Encode(number, 1000000000L, "billion");
			if (number < 1000000000000000L) return Encode(number, 1000000000000L, "trillion");
			if (number < 1000000000000000000L) return Encode(number, 1000000000000000L, "quadrillion");
			if (number <= long.MaxValue) return Encode(number, 1000000000000000000L, "quintillion");
			return string.Empty;
		}
